...
export function sanitizeMessages(raw: unknown): MessagesDoc {
  ...
  return {
    ...
    singleMonitor: bool(r.singleMonitor, DEFAULT_MESSAGES.singleMonitor),
    independentMonitorPositions: bool(r.independentMonitorPositions, DEFAULT_MESSAGES.independentMonitorPositions),
